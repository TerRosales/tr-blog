  ...
  return (
   <div className="min-h-screen mt-20">
    ...
    <div className="">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores optio deleniti possimus voluptatum? Ipsa itaque tempore ut quis, laboriosam, molestiae distinctio quae reiciendis voluptatibus praesentium alias, rerum aliquam.</p>
    </div>
    {/* right */}
    <div className=""></div>
    </div>
